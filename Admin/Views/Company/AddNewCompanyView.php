...
<?= $this->section('bodyClass') ?>reg-comp-page<?= $this->endSection() ?>
...
<?= $this->section('content') ?>
    ...
    <div class="register-container d-flex align-items-center justify-content-center min-vh-100">
            <div class="card shadow-sm register-container">
                <div class="card-body">
                    <h3 class="card-title text-center mb-3">Add Company</h3>
                    <p class="text-center">Enter the company details</p>
